...
VALUES
  ...
  ('Face Tracking (Self-Operated)', 'Monitor facial symptoms using front camera', 'skin_condition',
   ARRAY['Use front-facing camera for visibility', 'Hold phone at arm\'s length', 'Look directly at camera', 'Use natural lighting from front', 'Keep hair away from target areas'], 15, 30),
...
SET 
  pose_instructions = ARRAY[
    ...
    'Hold phone at comfortable arm\'s length',
